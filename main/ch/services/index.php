...
<div class="app">
        ...
        <div class="header__container">
            <div class="header__list-wrapper">
                <ul class="header__list">
                    ...
                    <!--<h5 class="header__content-title">-->
                    <!--Челябинск-->
                    <!--</h5>-->
                    <!--<p class="header__text header__text&#45;&#45;underline">Выберите город</p>-->
                    ...
                    <li class="header__item">
                        <div class="header__content-wrapper">
                            <h4 class="header__content-title ">
                                Rus
                            </h4>
                            <div class="header__picture-wrapper">
                                <a href="../../../page/services/"><img src="../http://images.trans-s.su/assets/images/Russia.gif" alt="" class="header__picture"></a>
                            </div>
                            ...
                            <div class="header__picture-wrapper">
                                <a href="../../en/page/services/"><img src="../http://images.trans-s.su/assets/images/USA.gif" alt="" class="header__picture"></a>
                            </div>
                            ...
                            <div class="header__picture-wrapper">
                                <img src="../http://images.trans-s.su/assets/images/china.gif" alt="" class="header__picture">
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="header__item">
                        <div class="header__content-wrapper">
                            ...
                            <a href="#form" class="header__button"> 与我们联系</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="nav__wrapper">
                <div class="nav__logo-wrapper m">
                    <a class="nav__link" href="../">
                        <!-- <img src="http://images.trans-s.su/assets/images/logo.png" alt="" class="nav__logo"> -->
                        <div class="top-logo">
                ...
                <li class="nav__item">
                    ...
                    <div class="nav__popup-wrapper">
                        <ul class="nav__popup-list">
                            ...
                            <li class="nav__popup-item">
                                <a href="../inform/trailers/" class="nav__popup-link">
                                    各種貨物汽車拖車和半拖車
                                </a>
                            </li>

                            <li class="nav__popup-item">
                                <a href="../inform/ironMobile/" class="nav__popup-link">
                                    車輛類型
                                </a>
                            </li>

                            <li class="nav__popup-item">
                                <a href="../inform/ironCont/" class="nav__popup-link">
                                    鐵路集裝箱的類型
                                </a>
                            </li>

                            <li class="nav__popup-item">
                                <a href="../inform/shipCont/" class="nav__popup-link">
                                    海運集裝箱的類型
                                </a>
                            </li>
                        </ul>
    ...
    <section class="services-blog">
      ...
      <div class="services-blog__item">
          <div class="item__text">
            ...
            <p>“TRANSSERVICE”公司通過以下類型的公路運輸提供貨物運輸服務： </p>
            ...
            <p>我们按照以下方向进行道路货物运输：</p>

            <ul class="text__list">
              <li>俄罗斯境内</li>
              <li>欧亚经济联盟国家（哈萨克斯坦，白俄罗斯，亚美尼亚，吉尔吉斯坦）</li>
              <li>亚洲国家（中国，蒙古，格鲁吉亚，塔吉克斯坦，乌兹别克斯坦）</li>
              <li>波罗的海国家（立陶宛，拉托维亚，爱沙尼亚）</li>
              <li>欧盟国家（德国，奥地利，捷克和其他国家）</li>
            </ul>

            <p>此外，我们还可以对所有货物给予保险和海关通关服务。</p>
          </div>
      ...
      <div class="services-blog__item">
        <div class="item__text">
          ...
          <p>“TRANSSERVICE”公司通過以下類型的機車車輛提供貨物運輸服務：</p> 
      ...
      <div class="services-blog__item">
        <div class="item__text">
            ...
            <p>«TRANSSERVICE» 公司提供与海上货物运输相关的全方位服务，包括：</p>
      ...
      <div class="services-blog__item">
        ...
        <div class="item__text">
          <h2>多式联运货物运输</h2>
            ...
            <p>«TRANSSERVICE» 公司提供与汽车，铁路和海运的多式联运货物相关的全套服务，包括： </p>
      ...
      <div class="services-blog__item">
          ...
          <div class="item__text">
            ...
            <p>«TRANSSERVICE» 公司通过以下类型的运输为超大型货物的运输提供服务：</p> 
      ...
      <div class="services-blog__item">
        ...
        <div class="item__text">
          ...
          <p>当运输货物通过公路，铁路或海运到俄罗斯联邦海关边境时，«TRANSSERVICE» 公司在通关组织提供服务，包括： </p>

          <ul class="text__list">
            <li>为货物申报准备相关文件</li>
            <li>从俄罗斯联邦境内电子申报出口货物</li>
            <li>往俄罗斯联邦境内电子申报进口货物</li>
          </ul>
    ...
    <section class="form">
        <div class="form__container">
            <form action="" class="form__content" id="form">
                <h3 class="form__title">聯繫我們</h3>
                <div class="form__input-fields-wrapper">
                    <div class="form__input-fields">
                        <input class="form__field form__name" type="text" placeholder="你的名字： ">
                        <input class="form__field form__mail" type="text" placeholder="你的電子郵件： ">
                        <input class="form__field form__tel" type="text" placeholder="你的電話號碼： ">
                    </div>

                    <div class="form__input-fields">
                    <textarea class="form__field form__field--textarea" type="text"
                              placeholder="我們如何幫助您"></textarea>
                    </div>
                </div>

                <div class="form__privacy">
                    <input class="form__checkbox" type="checkbox"  >
                    <a href="./politic/" class="form__accept">我同意用戶協議的條款 </a>
                </div>

                <input class="form__button" type="button" placeholder="Jnghfdbnm" value='發送' >
            </form>

            <div class="form__message">您的郵件已發送。</div>
        ...
        <div class="footer__container">
            <ul class="footer__list">
                <li class="footer__item">
                    <h4 class="footer__title">關於公司</h4>
                </li>

                <li class="footer__item">
                    <a href="../" class="footer__link">主</a>
                </li>

                <li class="footer__item">
                    <a href="./about/" class="footer__link">關於公司</a>
                </li>

                <li class="footer__item">
                    <a href="./contacts/" class="footer__link">往來</a>
                </li>
            </ul>
            ...
            <ul class="footer__list">
                ...
                <li class="footer__item">
                    <a href="../services/auto/" class="footer__link">公路运输</a>
                </li>
                <li class="footer__item">
                    <a href="../services/train/" class="footer__link">铁路运输</a>
                </li>
                <li class="footer__item">
                    <a href="../services/ship/" class="footer__link">海上运输</a>
                </li>
                <li class="footer__item">
                    <a href="../services/multimodal/" class="footer__link">多式联运货物运输</a>
                </li>
                <li class="footer__item">
                    <a href="../services/oversized/" class="footer__link">超大型货物运输</a>
                </li>
                <li class="footer__item">
                    <a href="../services/customs/" class="footer__link">報關</a>
                </li>
            </ul>

            <ul class="footer__list">
                <li class="footer__item">
                    <h4 class="footer__title"  >參考信息</h4>
                </li>
                <li class="footer__item">
                    <a href="../inform/incotermes/" class="footer__link">國際貿易術語</a>
                </li>
                <li class="footer__item">
                    <a href="../inform/trailers/" class="footer__link">各種貨物汽車拖車和半拖車</a>
                </li>
                <li class="footer__item">
                    <a href="../inform/ironMobile/" class="footer__link">車輛類型</a>
                </li>
                <li class="footer__item">
                    <a href="../inform/ironCont/" class="footer__link">鐵路集裝箱的類型</a>
                </li>
                <li class="footer__item">
                    <a href="../inform/shipCont/" class="footer__link">海運集裝箱的類型</a>
                </li>
            </ul>

            <ul class="footer__list">
                <li class="footer__item">
                    <h4 href="#" class="footer__title">往來</h4>
                </li>

                <li class="footer__item">
                    <h5 class="footer__text ">電話: 
                      <a href="tel:+7 351 700-02-04" class="footer__link">+7 351 700-02-04</a>
                    </h5>
                </li><br>

                <li class="footer__item">
                    <h5 class="footer__text ">郵件: 
                      <a href="mail:info@trans-s.su" class="footer__link">info@trans-s.su</a>
                    </h5>
                </li><br>

                <li class="footer__item">
                    <h5 class="footer__text ">454048, Chelyabinsk, ul. Enthusiasts, d.30, of.406</h5>
                </li>
            </ul>
        </div>
    </footer>
