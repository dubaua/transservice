...
<head>
    ...
    <title>Инкотермс. Условия поставки товаров</title>
    <meta name="description" content="Правила международной торговли. Подготовка и оформление документов с учетом стандарта инкотермс. Условия поставки грузов.">
...
<div class="app">
    ...
    <section class="incotermes__info">

      <div class="wrapper">
        <div class="info__header">
          <h2 class="header__title">Инкотермс</h2>
        ...
        <div class="info__main">
          <img src="http://images.trans-s.su/assets/images/Incoterms.jpg" alt="картинка" class="main__img" alt="Правила Инкотермс" title="Правила Инкотермс">
        </div>
      </div>
