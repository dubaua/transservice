...
<head>
    ...
    <title>Виды грузовых автомобильных прицепов и полуприцепов</title>
    <meta name="description" content="Транспортная компания Транс Сервис – международные перевозки и грузоперевозки по всей России. Виды грузовых автомобильных прицепов и полуприцепов.">
...
<div class="app">
    ...
    <section class="trailers incotermes__info">

      <div class="wrapper">
        <div class="info__header">
          <h2 class="header__title">Виды грузовых автомобильных прицепов и полуприцепов</h2>
        </div>

        <div class="info__main">
          <div><img src="http://images.trans-s.su/assets/images/auto/82cbm.jpg" alt="картинка"></div>
          <div><img src="http://images.trans-s.su/assets/images/auto/90cbm.jpg" alt="картинка"></div>
          <div><img src="http://images.trans-s.su/assets/images/auto/96cbm.jpg" alt="картинка"></div>
          <div><img src="http://images.trans-s.su/assets/images/auto/110cbm.jpg" alt="картинка"></div>
          <div><img src="http://images.trans-s.su/assets/images/auto/120cbm.jpg" alt="картинка"></div>
        </div>
      </div>
